...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 19, 2016 at 08:20 AM
...
--
-- Table structure for table `ms_edu_level`
--

CREATE TABLE `ms_edu_level` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `ms_edu_level`
--

INSERT INTO `ms_edu_level` (`id`, `name_th`, `name_en`, `status`, `deleted`, `created_date`, `created_by`, `updated_date`, `updated_by`) VALUES
(1, 'ประถมศึกษา', 'ประถมศึกษา', 1, 0, '2016-03-08 05:18:24', 1, '2016-03-08 05:18:24', 1),
(2, 'มัธยมศึกษา', 'มัธยมศึกษา', 1, 0, '2016-03-08 05:18:55', 1, '2016-03-08 05:18:55', 1),
(3, 'อุดมศึกษา', 'อุดมศึกษา', 1, 0, '2016-03-08 05:20:25', 1, '2016-03-08 05:20:25', 1),
(4, 'บัณฑิตศึกษา', 'บัณฑิตศึกษา', 1, 0, '2016-03-08 05:20:47', 1, '2016-03-08 05:20:47', 1);
...
--
-- Dumping data for table `ms_institution`
--

INSERT INTO `ms_institution` (`id`, `name_th`, `name_en`, `status`, `deleted`, `created_date`, `created_by`, `updated_date`, `updated_by`) VALUES
(1, 'โรงเรียนสาธิตมหาวิทยาลัยศรีนครินทรวิโรฒ ประสานมิตร', 'โรงเรียนสาธิตมหาวิทยาลัยศรีนครินทรวิโรฒ ประสานมิตร', 1, 0, '2016-03-08 06:55:56', 1, '2016-03-08 06:55:56', 1);
...
--
-- Dumping data for table `ms_institution_type`
--

INSERT INTO `ms_institution_type` (`id`, `name_th`, `name_en`, `status`, `deleted`, `created_date`, `created_by`, `updated_date`, `updated_by`) VALUES
(1, 'รัฐ', 'รัฐ', 1, 0, '2016-03-08 03:43:17', 1, '2016-03-08 03:43:17', 1),
(2, 'เอกชน', 'เอกชน', 1, 0, '2016-03-08 03:43:40', 1, '2016-03-08 03:43:40', 1);
...
--
-- Dumping data for table `ms_lecturer`
--

INSERT INTO `ms_lecturer` (`id`, `name_th`, `name_en`, `status`, `deleted`, `created_date`, `created_by`, `updated_date`, `updated_by`) VALUES
(1, 'ทนงศักดิ์ บุญโสม', 'ทนงศักดิ์ บุญโสม', 1, 0, '2016-03-08 07:47:43', 1, '2016-03-08 07:47:43', 1);
...
INSERT INTO `ms_province` (`id`, `name_th`, `name_en`, `status`, `deleted`, `created_date`, `created_by`, `updated_date`, `updated_by`) VALUES
(1, 'กรุงเทพมหานคร', 'Bangkok', 1, 0, '2016-03-08 03:51:55', 1, '2016-03-08 03:51:55', 1);
...
CREATE TABLE `trn_edu_testing` (
  ...
  `edu_lv_testing_id` int(11) DEFAULT NULL,
  `edu_test_id` int(11) DEFAULT NULL,
...
--
-- Dumping data for table `trn_edu_testing`
--

INSERT INTO `trn_edu_testing` (`id`, `ins_id`, `ins_type_id`, `province_id`, `obj_id`, `edu_lv_testing_id`, `edu_test_id`, `lecturer_id`, `status`, `deleted`, `created_date`, `created_by`, `updated_date`, `updated_by`) VALUES
(1, 1, 2, 1, 2, 2, 1, 1, 1, 0, '2016-03-08 08:06:42', 1, '2016-03-08 08:06:42', 1);
...
--
-- Indexes for table `ms_edu_level`
--
ALTER TABLE `ms_edu_level`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT for table `ms_edu_level`
--
ALTER TABLE `ms_edu_level`
