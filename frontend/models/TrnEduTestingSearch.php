...
use frontend\models\TrnEduTesting;

/**
 * TrnEduTestingSearch represents the model behind the search form about `frontend\models\TrnEduTesting`.
 */
class TrnEduTestingSearch extends TrnEduTesting
{
    ...
    {
        return [
            [['id', 'ins_id', 'obj_id', 'test_type_id', 'count_examiner', 'trn_edu_testing_edu_level_id', 'trn_edu_testing_edu_level_phase_id', 'trn_edu_testing_test_set_id', 'trn_edu_testing_lecturer_id', 'status', 'deleted', 'created_by', 'updated_by'], 'integer'],
    ...
    public function search($params)
    {
        ...
        $query->joinWith('trnEduTestingSubjects');
        $query->andFilterWhere([
            ...
            'trn_edu_testing_edu_level_phase_id' => $this->trn_edu_testing_edu_level_phase_id,
