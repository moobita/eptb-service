 ...
 *
 * @property TrnEduTestingEduLevel[] $trnEduTestingEduLevels
 * @property TrnEduTestingLecturer[] $trnEduTestingLecturers
 * @property TrnEduTestingSubjects[] $trnEduTestingSubjects
 * @property TrnEduTestingTestSet[] $trnEduTestingTestSets
 */
class TrnEduTesting extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['ins_id', 'obj_id', 'test_type_id', 'count_examiner', 'trn_edu_testing_edu_level_id', 'trn_edu_testing_edu_level_phase_id', 'trn_edu_testing_test_set_id', 'trn_edu_testing_lecturer_id', 'status', 'deleted', 'created_by', 'updated_by'], 'integer'],
            [['test_start'], 'required'],
    ...
    {
        return $this->hasMany(TrnEduTestingEduLevel::className(), ['trn_edu_testing_id' => 'id']);
    }

    /**
     * @return \yii\db\ActiveQuery
     */
    public function getTrnEduTestingLecturers()
    {
        return $this->hasMany(TrnEduTestingLecturer::className(), ['trn_edu_testing_id' => 'id']);
    }

    /**
     * @return \yii\db\ActiveQuery
     */
    public function getTrnEduTestingSubjects()
    {
        return $this->hasMany(TrnEduTestingSubjects::className(), ['trn_edu_testing_id' => 'id']);
    }

    /**
     * @return \yii\db\ActiveQuery
     */
    public function getTrnEduTestingTestSets()
    {
        return $this->hasMany(TrnEduTestingTestSet::className(), ['trn_edu_testing_id' => 'id']);
    }
}
