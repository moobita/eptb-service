...
/**
 * MsObjectiveSearch represents the model behind the search form about `common\models\MsObjective`.
 */
class MsObjectiveSearch extends MsObjective
{
    /**
     * @inheritdoc
     */
