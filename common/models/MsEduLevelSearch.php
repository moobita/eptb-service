...
/**
 * MsEduLevelSearch represents the model behind the search form about `common\models\MsEduLevel`.
 */
class MsEduLevelSearch extends MsEduLevel
{
    /**
     * @inheritdoc
     */
