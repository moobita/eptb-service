...
/**
 * MsProvinceSearch represents the model behind the search form about `common\models\MsProvince`.
 */
class MsProvinceSearch extends MsProvince
{
    /**
     * @inheritdoc
     */
