...
/* @var $searchModel common\models\MsTestTypeSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'ประเภทแบบทดสอบ';
$this->params['breadcrumbs'][] = $this->title;

?>
<div class="ms-test-type-index">

    <h1><?= Html::encode($this->title) ?></h1>
    <?php // echo $this->render('_search', ['model' => $searchModel]); ?>

    <div class="col-lg-12" align="right">
        <?= Html::button('<i class="fa fa-plus"></i> เพิ่มประเภทแบบทดสอบ', 
	...
	<?php Pjax::begin(['id'=>'testtype_pjax_id']); ?>
    <?= GridView::widget([
            		...
            		'buttons' => [
            				...
            				return Html::a('<span class="glyphicon glyphicon-trash"></span>',
            						...
            						['class'          => 'btn btn-default clfor-delete',
            								//'delete-url'     => $url,
            								'delete-url' => '?r=ms-test-type/delete&id='.$key,
            								'pjax-container' => 'testtype_pjax_id',
...
$this->registerJs(' 
		function init_click_handlers(){ 
			...
			$("#activity-create-link").click(function(e) { 
				$.get( 
					"?r=ms-test-type/create", 
					function (data) { 
						$("#modal").find(".modal-body").html(data); 
						$(".modal-title").html("เพิ่มประเภทแบบทดสอบ"); 
			...
			$(".clfor-view-modal").click(function(e) { 
 				...
 				$.get( 
 					...
 					function (data) { 
 						$("#modal").find(".modal-body").html(data); 
 						$(".modal-title").html("ข้อมูลประเภทแบบทดสอบ");
						$(".modal-body").html(data);
 						$("#modal").modal("show"); 
 					} 
 				); 
			...
			$(".clfor-update-modal").click(function(e) { 
 				var fID = $(this).attr("data-id");
 				$.get( 
 					"?r=ms-test-type/update", 
 					{ id: fID }, 
 					function (data) { 
 						$("#modal").find(".modal-body").html(data);
						$(".modal-title").html("แก้ไขประเภทแบบทดสอบ"); 
 						$(".modal-body").html(data); 
 						$("#modal").modal("show"); 
 					} 
 				); 
		...
		$("#testtype_pjax_id").on("pjax:success", function() { 
