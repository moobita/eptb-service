...
/* @var $searchModel common\models\MsObjectiveSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'วัตถุประสงค์ในการสอบ';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="ms-objective-index">

    <h1><?= Html::encode($this->title) ?></h1>
    <?php // echo $this->render('_search', ['model' => $searchModel]); ?>

    <div class="col-lg-12" align="right">
        <?= Html::button('<i class="fa fa-plus"></i> เพิ่มวัตถุประสงค์ในการสอบ', 
	...
	<?php Pjax::begin(['id'=>'objective_pjax_id']); ?>
    <?= GridView::widget([
            		...
            		'buttons' => [
            				...
            				return Html::a('<span class="glyphicon glyphicon-trash"></span>',
            						...
            						['class'          => 'btn btn-default clfor-delete',
            								//'delete-url'     => $url,
            								'delete-url' => '?r=ms-objective/delete&id='.$key,
            								'pjax-container' => 'objective_pjax_id',
...
$this->registerJs(' 
		function init_click_handlers(){ 
			...
			$("#activity-create-link").click(function(e) { 
				$.get( 
					"?r=ms-objective/create", 
					function (data) { 
						$("#modal").find(".modal-body").html(data); 
						$(".modal-title").html("เพิ่มวัตถุประสงค์ในการสอบ"); 
			...
			$(".clfor-view-modal").click(function(e) { 
 				...
 				$.get( 
 					...
 					function (data) { 
 						$("#modal").find(".modal-body").html(data); 
 						$(".modal-title").html("ข้อมูลวัตถุประสงค์ในการสอบ");
						$(".modal-body").html(data);
 						$("#modal").modal("show");
 					} 
 				); 
			...
			$(".clfor-update-modal").click(function(e) { 
 				var fID = $(this).attr("data-id");
 				$.get( 
 					"?r=ms-objective/update", 
 					{ id: fID }, 
 					function (data) { 
 						$("#modal").find(".modal-body").html(data);
						$(".modal-title").html("แก้ไขวัตถุประสงค์ในการสอบ"); 
 						$(".modal-body").html(data); 
 						$("#modal").modal("show"); 
 					} 
 				); 
		...
		$("#objective_pjax_id").on("pjax:success", function() { 
